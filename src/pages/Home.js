  ...
  return (
    <section>
          ...
          <div className="nav-home">
            ...
            <nav className="navbar navbar-expand-md">
              <div className="container-fluid">
                ...
                <div className="navbar-collapse collapse justify-content-center text-center" id="collapseNavbar">
          ...
          <form  role="search">
            <div className="searchbar"> 
                <div className="searchbar-home p-2">
                  <input className="form-control me-2 searchbar-input" type="search" placeholder="Search Furniture" aria-label="Search" />
      ...
      <div className="about-us main">
            <Row>
               <Col className="about-left-texts"><h3>Why <br/>Choosing Us</h3></Col>
               <Col>
